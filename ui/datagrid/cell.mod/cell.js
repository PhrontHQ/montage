    ...
    enterDocument: {
        value: function (isFirstTime) {
            if (isFirstTime) {
                ...
                this.defineBinding("classList.has('isEditable')", {"<-": "datagrid.isEditable && columnDescriptor.isEditable && !isDisabled"});
                this.defineBinding("classList.has('isDisabled')", {"<-": "isDisabled"});
